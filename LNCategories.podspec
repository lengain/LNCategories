#
#  Be sure to run `pod spec lint LNCategories.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  categories of iOS. UIKit's categories,Foundation's categories
                   DESC

  s.homepage     = "https://github.com/lengain/LNCategories"
  ...
  # s.authors            = { "lengain" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/lengain/LNCategories.git", :tag => "#{s.version}"}
